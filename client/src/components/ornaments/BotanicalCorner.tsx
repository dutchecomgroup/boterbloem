...
/** A small elegant botanical sprig in a corner. Uses currentColor — set color via text-* utility. */
export function BotanicalCorner({
  ...
  return (
    <svg
      ...
      fill="none"
      aria-hidden="true"
      className={cn("absolute pointer-events-none", POSITIONS[position], ROTATIONS[position], color, className)}
    >
      {/* main stem */}
      <path
